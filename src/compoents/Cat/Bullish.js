  ...
  return (
    <>
      <div className="car_section" >
        <div className="gaming_title" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800" >
          <h1>
        ...
        <div className="container-fluid Bullish_section">
          <div className="row">
            <div className="col-md-6" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800" >
              <img src={car} alt="" className="img-fluid" />
            </div>
            <div className="col-md-6" data-aos="zoom-in-up" data-aos-easing="ease-in-sine" data-aos-duration="800" >
